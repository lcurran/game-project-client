...
/***/ function(module, exports, __webpack_require__) {
	...
	var boardEvents = __webpack_require__(8);
	var authUiEvents = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGameStats = function onGameStats() {
	  ...
	  if (app.user === undefined || app.user === null) {
	    ...
	    api.getGameInfo().done(ui.gameStatsSuccess).fail(ui.failure);
	  }
	};
	//
	...
	var onCellSelect = function onCellSelect(event) {
	  event.preventDefault();
	  var cellId = $(event.target).attr("id");
	  var index = cellId.replace(/\D/g, '');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cellFiller = function cellFiller(cellId, index) {
	  board[index] = player();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var occupiedError = function occupiedError() {
	  $('#occupied-modal').modal('show');
	};

	var placeMarker = function placeMarker(cellId, index) {
	  if (board[index] === 'x') {
	...
	var playerWin = function playerWin(winner) {
	  if (winner === 'x') {
	...
	var tieAlert = function tieAlert() {
	...
	var gameIdSuccess = function gameIdSuccess(data) {
...
/***/ function(module, exports) {
	...
	// for (let i = 0, max = data.length; i < max; i++) {
	//   if (data.games[i].over === false) {
	//     $('#active-games').find('tr').append('<tr><td>' +
	//      data.games[i].id + '</td><td>' +
	//      data.games[i].player_o.email + '</td></tr>');
	//   }
	// }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rowWinCheck = function rowWinCheck(board) {
	  for (var i = 0, max = 6; i <= max; i += 3) {
	...
	var columnWinCheck = function columnWinCheck(board) {
	...
	var diagonalWinCheck = function diagonalWinCheck(board) {
	...
	var winChecker = function winChecker(board) {
	  var winner = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var boardSum = function boardSum(board) {
	  var sum = 0;
	  for (var i = 0, max = board.length; i < max; i++) {
	...
	var tieChecker = function tieChecker(board) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGameData = function updateGameData(board, index) {
	  var data = {
	    game: {
	      cell: {
	        index: index,
	...
	var endGameData = function endGameData(board, index) {
	  var data = {
	    game: {
	      cell: {
	        index: index,
